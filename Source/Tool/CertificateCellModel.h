...
@property (nonatomic,assign) NSInteger page; // 照片所在相册的页数
@property (nonatomic,retain) PHAssetCollection *assetCollection; // 所在相册

@property (nonatomic,retain) UIImage *itemImage; // 相册中的图片数据_压缩版
@property (nonatomic,retain) UIImage *bigImage; // 相册中的图片数据_清晰版
